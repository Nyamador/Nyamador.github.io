...
var Layout = function() {
    function e(e) {
        ...
        $("body").find(".main-content").append('<div class="sidenav-mask mask-body d-xl-none" data-action="sidenav-unpin" data-target=' + e.data("target") + " />"),
    ...
    $("body").on("click", "[data-action]", function(a) {
        ...
        case "offcanvas-open":
            i = n.data("target"),
            $(i).addClass("open"),
            $("body").append('<div class="body-backdrop" data-action="offcanvas-close" data-target=' + i + " />");
            break;
        ...
        case "aside-open":
            ...
            n.addClass("active"),
            $(i).addClass("show"),
            $("body").append('<div class="mask-body mask-body-light" data-action="aside-close" data-target=' + i + " />");
            break;
        case "aside-close":
            i = n.data("target"),
        ...
        case "omnisearch-open":
            ...
            $("body").addClass("omnisearch-open").append('<div class="mask-body mask-body-dark" data-action="omnisearch-close" data-target="' + i + '" />');
            break;
  ...
  , BgImgHolder = function() {
    ...
    e.length && e.each(function() {
        ...
        e.css("background-image", 'url("' + t + '")').css("background-position", a).css("background-size", n).css("opacity", "1").css("height", o)
    })
}()
  , CardActions = function() {
    ...
    e.length && $(t).length && (e.on({
        mouseenter: function() {
            ...
            a.length && (a.addClass("in animated " + n),
    ...
    e.on({
        mouseleave: function() {
            ...
            a.length && (a.addClass("animated " + n),
            a.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
  ...
  , Dropdown = function() {
    ...
    t.length && t.on("click", function(e) {
        return function(e) {
            ...
            e.parents(".nav-item.dropdown.show").on("hidden.bs.dropdown", function(e) {
    ...
    e.length && e.each(function() {
        ...
        e.on("change", function(t) {
            !function(e, t, a) {
                ...
                t && t.files.length > 1 ? n = (t.getAttribute("data-multiple-caption") || "").replace("{count}", t.files.length) : a.target.value && (n = a.target.value.split("\\").pop()),
  ...
  , PasswordText = function() {
    ...
    e.length && e.on("click", function(e) {
        var t, a;
        t = $(this),
        "password" == (a = $(t.data("target"))).attr("type") ? a.attr("type", "text") : a.attr("type", "password")
    })
}()
  , Pricing = function() {
    ...
    e.length && t.on({
        click: function() {
            !function(e) {
                ...
                e.hasClass("active") || ($("." + t.attr("class") + " button[data-pricing]").removeClass("active"),
                e.addClass("active"),
                a.each(function() {
  ...
  , ScrollTo = function() {
    ...
    function a(e) {
        ...
        $("html, body").stop(!0, !0).animate(n, 300),
        ...
        return function(e, a) {
            ...
            if (a.isDefaultPrevented())
                ...
                i.done(function(a, o) {
                    ...
                    "success" == i && (e.find(".btn-reset").trigger("click"),
                    grecaptcha.reset()),
  ...
  , GoogleMap = function() {
    ...
    void 0 !== a && null != a && google.maps.event.addDomListener(window, "load", function(a) {
        e = a.getAttribute("data-lat"),
        t = a.getAttribute("data-lng");
...
var Dropzones = function() {
  ...
  , Fullcalendar = function() {
    ...
    $("body").on("click", "[data-calendar]", function() {
        ...
        "delete" === t && ($("#edit-event").modal("hide"),
        setTimeout(function() {
            swal({
                title: "Are you sure?",
                ...
                t.value && (e.fullCalendar("removeEvents", a),
                swal({
                    title: "Deleted!",
  ...
  , Highlight = function() {
    $(".highlight").each(function(e, t) {
        !function(e, t) {
            $(t).before('<button class="action-item btn-clipboard" title="Copy to clipboard"><i class="far fa-copy mr-2"></i>Copy</button>'),
  ...
  , WpxSwiper = function() {
    ...
    $(document).ready(function() {
        e.length && e.each(function(e, t) {
            ...
            p = !!n.data("swiper-centered-slides") && n.data("swiper-centered-slides"),
            g = n.data("swiper-pagination-type") ? n.data("swiper-pagination-type") : "bullets",
